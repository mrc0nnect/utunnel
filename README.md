...
```
bash <(curl -s https://raw.githubusercontent.com/mrc0nnect/utunnel/refs/heads/main/install_utunnel.sh --ipv4)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/mrc0nnect/utunnel/refs/heads/main/MonitorBotinstall.sh --ipv4)
```
پس از اجرا:
